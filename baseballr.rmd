...
# # 
lm_pitcher_full_game <- lm(game_fp ~ (mpdp + park_adjust + b_allowed_fps + p_earned_fps + sum_pitch_factors + H + HR + ERA + mean_batters_faced + IP + SO) / ( mad_fps + sum_bat_factors) , data = na.omit(pitchers_by_game))
summary(lm_pitcher_full_game)
...
lm_pitcher_second_level <- lm(game_fp ~ pred + mean_projection , data = pitchers_by_game)
summary(lm_pitcher_second_level)
# Adjusted R-squared:  0.3851

newpred <- predict(lm_pitcher_second_level, pitchers_by_game)
